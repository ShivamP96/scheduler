...
import {render, cleanup, getByPlaceholderText, getByTestId, getByDisplayValue } from "@testing-library/react";
...
describe("Form", () => {
  ...
  // destructure getbyPlaceholderText test helper funciton from the object that render returns
